...
var TFCompound = artifacts.require('./TFCompound.sol')
...
module.exports = function(deployer, network, accounts) {
  deployer.then(async () => {
    ...
    const alCompound = await deployer.deploy(ALCompound, comptroller.address) // LOCAL
    ...
    console.log(`  "ALCompound": "${alCompound.address}"`)
    console.log(`  "TFCompound": "${tfCompoundDAI.address}"`)
    console.log(`  "TFCompound": "${tfCompoundUSDC.address}"`)
    console.log('}')
  })
};
